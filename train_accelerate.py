...
def main(args, unparsed):
    ...
    if args.feature_path is None:
        ...
        if accelerator.is_main_process:
            print(f'---> Preload Imagenet VAE features at {args.feature_path}...')
    ...
    start_time = time()
    if accelerator.is_main_process:
        logger.info(f"Training for {args.start_epoch}~{args.epochs} epochs...")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model-domain", type=str, default='dic')
